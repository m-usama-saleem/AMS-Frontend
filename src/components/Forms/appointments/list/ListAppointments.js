...
class ListAppointments extends Component {
        ...
        this.setState({ CheckFields: true }, () => {
          this.setState({ changeState: this.state.changeState + 1 }, () => {
            ...
            if (
              ...
              (this.state.SelectedAppointmentDate &&
                this.state.SelectedAppointmentDate.toString().trim() === "")
            ) {
              this.setState({ isAppointmentDateValid: false });
              error += "Termin cannot be empty \n";
            } else {
              this.setState({ isAppointmentDateValid: true });
            }
        ...
        this.validateForm().then((result) => {
          if (result !== false) {
            ...
            this.growl.show({
              severity: "error",
              summary: "Fehler",
              detail: "Fehler: beim Auftrag erstellen",
            });
    ...
    SaveAppointment() {
      ...
      SelectedAppointmentDate.setHours(curr_date.getHours());
      SelectedAppointmentDate.setMinutes(curr_date.getMinutes());
            ...
            .then((data) => {
              if (data.success == true) {
                this.growl.show({
                  severity: "success",
                  summary: "Erfolg",
                  detail: "Termin erfolgreich erstellt",
                });
                this.setState(
                  {
                    isLoading: false,
        ...
        this.validateForm().then((result) => {
          if (result !== false) {
            ...
            this.growl.show({
              severity: "error",
              summary: "Fehler",
              detail: "Fehler: beim Auftrag aktualisieren",
            });
            this.setState({ isLoading: false });
          }
        });
            ...
            .then((data) => {
              if (data.success == true) {
                this.growl.show({
                  severity: "success",
                  summary: "Erfolg",
                  detail: "Termin erfolgreich aktualisiert",
                });
    ...
    editMode(appointment) {
      this.setState({ displayEditDialog: true }, () => {
        ...
        const transInd = AllTranslators.findIndex(
          (x) => x.value == appointment.translatorId
        );
        const instInd = AllInstitutions.findIndex(
          (x) => x.value == appointment.institutionId
        );
        const langId = Languages.findIndex(
          (x) => x.value == appointment.language
        );

        var LanguageSelection = [];
        const translator_languages =
          AllTranslators[transInd].languages.split(",");
        translator_languages.forEach((name) => {
        ...
        this.service
          ...
          .then(() => {
            ...
            this.growl.show({
              severity: "success",
              summary: "Erfolg",
              detail: "Termin erfolgreich genehmigt",
            });
            this.setState(
              {
                AllAppointments,
          ...
          .catch((error) => {
            ...
            this.growl.show({
              severity: "error",
              summary: "Fehler",
              detail: "Fehler beim Genehmigen des Termins",
            });
          });
      }
    }
    onDeleteAppointment() {
      ...
      if (id != undefined && id != null && id != 0) {
        this.service
          .Delete({ id, text, userId })
          .then(() => {
            var list = this.state.AllAppointments.filter((x) => x.id !== id);
            this.growl.show({
              severity: "success",
              summary: "Erfolg",
              detail: "Termin erfolgreich entfernt",
            });
            this.setState({
          ...
          .catch((error) => {
            ...
            this.growl.show({
              severity: "error",
              summary: "Fehler",
              detail: "Fehler beim Löschen des Termins",
            });
          });
      }
    }
      ...
      return (
        <React.Fragment>
          ...
          <Button
            ...
            onClick={() => this.confirmApproveAppointment(rowData)}
            title="bestätigen"
    ...
    getEditAppointmentDialog() {
      ...
      if (Status !== "teilweise abgeschlossen") {
        EditAppointmentButton = (
          <span className="ui-float-label" style={{ float: "right" }}>
            <Button
              label="Termin aktualisieren"
              className="ui-btns"
              disabled={this.state.isLoading}
              onClick={() => this.onEditAppointment()}
            />
          </span>
        );
      }
      ...
      if (
        ...
        this.state.AttachmentFiles != "" &&
        this.state.AttachmentFiles.split(",").length > 0
      ) {
      ...
      return (
        <Dialog
          ...
          style={{ width: "60vw" }}
          header="Termin Informationen"
          modal={true}
          onHide={() =>
            this.setState({ displayEditDialog: false }, () => this.resetForm())
          }
            ...
            <div className="p-grid p-fluid">
              <div className="card card-w-title">
                ...
                <div className="p-grid">
                  <div className="row">
                    ...
                    >
                      <AMSInputField
                        ...
                        PlaceholderText="Aktenzeichen"
                        onChange={(val) => this.setState({ AppointmentId: val })}
                        ChangeIsValid={(val) =>
                          this.setState({ ValidAppointmentId: val })
                        }
                  ...
                  <div className="row">
                    ...
                    >
                      <AMSInputField
                        ...
                        PlaceholderText="Suche Institution"
                        ItemsList={this.state.AllInstitutions}
                        onChange={(val) =>
                          this.setState({ SelectedInstituteName: val })
                        }
                        CheckField={this.state.CheckFields}
                        ChangeIsValid={(val) =>
                          this.setState({ ValidInstitute: val })
                        }
                      />
                    </div>
                    <div
                    ...
                    >
                      <span className="ui-float-label">
                        <label htmlFor="float-input">
                          Termin <span style={{ color: "red" }}>*</span>
                        </label>
                        <DatePicker
                          ...
                          locale="de"
                          className={
                            this.state.isAppointmentDateValid === true
                              ? "p-inputtext normalbox"
                              : "p-inputtext errorBox"
                          }
                        />
                      </span>
                    </div>
                  ...
                  <div className="row">
                    ...
                    >
                      <AMSInputField
                        ...
                        CheckField={this.state.CheckFields}
                        ChangeIsValid={(val) =>
                          this.setState({ ValidTranslator: val })
                        }
                      />
                    </div>
                    <div
                    ...
                    >
                      <AMSInputField
                        ...
                        ItemsList={langList}
                        onChange={(val) =>
                          this.setState({ SelectedLanguageName: val })
                        }
                        CheckField={this.state.CheckFields}
                        ChangeIsValid={(val) =>
                          this.setState({ ValidLanguage: val })
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div
                    className="p-col-12 p-sm-12 p-md-12 p-lg-12"
                    style={{ color: "red" }}
                  >
                    {this.state.error === true
                      ? "Please fill all the required(red marked) fields"
                      : null}
                  </div>
                  <div className="sm-4 md-2 lg-2">{EditAppointmentButton}</div>
                </div>
              </div>
            </div>
          }
    ...
    getNewAppointmentDialog() {
      ...
      return (
        <Dialog
          ...
          style={{ width: "60vw" }}
          header="Neuen Termin erstellen"
          modal={true}
          onHide={() => this.setState({ displayCreateDialog: false })}
          contentStyle={{ maxHeight: "550px", overflow: "auto" }}
        >
          {
            <div className="p-grid p-fluid">
    ...
    render() {
      var { disableFields, disableDeleteButton, disableApproveButton } =
        this.state;
      var header;
            ...
            <div className="card card-w-title">
              ...
              <div className="content-section implementation">
                <DataTable
                  ...
                  onRowDoubleClick={this.dblClickAppointment}
                  responsive={true}
                  ...
                  columnResizeMode="fit" /*rowClassName={this.rowClass}*/
                ...
                >
                  ...
                  <Column
                    ...
                    header="Termin"
                    sortFunction={(e) => this.sortDates(e)}
                    sortable={true}
                    style={{ textAlign: "center" }}
                  />
                  <Column
                    field="translatorName"
                    header="Dolmetscher/ Übersetzer"
                    sortable={true}
                  />
                  <Column
                ...
                >
                  {this.state.isLoading === true ? (
                    <div>
                      ...
                      <ProgressBar
                        style={{ marginTop: "40px", height: "2px" }}
                        mode="indeterminate"
                      />
                    </div>
                  ) : null}
                ...
                <Dialog
                  ...
                  width="400px"
                  header="Möchten Sie diesen Termin wirklich löschen?"
                  modal={true}
                ...
                <Dialog
                  visible={this.state.displayApproveDialog}
                  width="300px"
                  header="Sind Sie sicher, dass Sie diesen Termin genehmigen?"
                  modal={true}
                  onHide={() => this.setState({ displayApproveDialog: false })}
                >
                  {
                    <div
                      className="ui-dialog-buttonpane p-clearfix"
                    ...
                    >
                      <Button
                        ...
                        onClick={() => this.onApproveAppointment()}
                      />
                      <Button
                        label="No"
                        style={{ width: 100, marginLeft: 5 }}
